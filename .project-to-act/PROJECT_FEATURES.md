...
| F-006 | 0903 PMC 数据需求与现有数据优化审计 | 高 | 已完成 | 真实订单、业务目录、PMC v2 snapshot 合同、WIP 来源审计 | 形成缺失数据、已有数据优化、交付文件模板和真实 PMC 验收门槛；未将数据需求文档误判为生产验收 | E-0903-DATA-REQ-001 |
...
- 2026-09-03：新增 F-006 0903 PMC 数据需求与现有数据优化审计；基于真实订单、441 个业务目录候选、PMC v2 六类 snapshot 合同和 WIP 来源审计，区分 P0 阻断数据、P1 完整性数据及订单/BOM/SOP/资源/供应/时间/证据字段优化；证据 `E-0903-DATA-REQ-001`；确认来源：本次审计。
