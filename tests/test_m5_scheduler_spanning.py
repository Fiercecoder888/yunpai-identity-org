...
from yunpai_langgraph.pmc_v2_scheduler import RunContext, _place_processing
from yunpai_langgraph.pmc_v2_snapshots import to_minutes, parse_dt
...
def test_equipment_anchor_in_lunch_gap_starts_at_next_window():
    ...
    from yunpai_langgraph.pmc_v2_adapter import build_bundle
