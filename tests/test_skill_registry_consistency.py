...
from yunpai_langgraph.agents import SKILL_USAGE_ORDER
from yunpai_langgraph.llm import QwenConfig, QwenRouter
from yunpai_langgraph.registry import build_default_registry
from yunpai_langgraph.skills import SkillRegistry, build_default_skill_registry
...
def _op_map_tools(skill_name: str, skills: SkillRegistry) -> set[str]:
    ...
    module_skill_ops = {
        ...
        "yunpai-m5-pmc-lifecycle": {"default": "get_m5_schedule", "schedule": "get_m5_schedule", "versions": "list_m5_schedules", "replan": "replan_m5_schedule", "dispatch": "dispatch_m5_schedule", "execution": "get_m5_execution_summary", "progress": "get_m5_pmc_progress"},
    }
